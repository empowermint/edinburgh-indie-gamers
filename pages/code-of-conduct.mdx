...
export const meta = {
  ...
  description: "Edinburgh Indie Gamers' Code of Conduct is a collaborative document designed to make our community fun for all. You can use it too under a Creative Commons licence."
}
